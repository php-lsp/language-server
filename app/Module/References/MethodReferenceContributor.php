...
final class MethodReferenceContributor implements ReferenceContributor
{
    ...
    public function contribute(ReferenceContext $context, ReferenceConsumer $consumer): void
    {
        ...
        $methodName = $this->resolveMethodName($element);
        if ($methodName === null) {
            return;
        }
    ...
    private function resolveMethodName(?Node $element): ?string
    {
        if ($element === null) {
            return null;
        }
